...
namespace CarPool.DB.Migrations
{
    ...
    [Migration("20200131060306_AddedSoftDeletionAttributes")]
    partial class AddedSoftDeletionAttributes
    {
            ...
            modelBuilder.Entity("CarPool.DB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "SamYoung",
                            Password = "qazwsxedc",
                            RowDeletedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RowModifiedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
